...
<template>
  <div>
    ...
    <p class="text-sm text-gray-500 mb-8">Sign in to your Flowgent account</p>
    ...
    <div class="flex gap-3">
      <button class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200">
